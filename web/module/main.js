import { crawl_tkb } from "../../main.js"

const $ = document

function import_tkb(){
    const source_code = document.getElementById('source')
    const html_form_source = document.createElement('html')
    html_form_source.innerHTML = source_code
    crawl_tkb(source_code.querySelectorAll('div.grid-roll2 > table'))
}
